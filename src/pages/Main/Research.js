      ...
      <Body>
        ...
        <Col left>
          <Text>
            ...
            >
              ...
              feel them, they just happen to us automatically. Of all the <br />
        ...
        <ColSecond>
          <Text>
            ...
            and depressing the lower lip. <br />• Fear: raising the inner angle
            of the brow, raising the <br />
            outer part of the brow, lowering the brows, raising the <br />
            upper eye-lid, tightening an eye-lid, stretching the lips, <br />
            and dropping one’s jaw. <br />• Happiness: raising one’s cheeks and
            pulling up the <br />
          ...
          />
          <ImageFig5Remark>
            Fig. 5: Examples of Action Units (AU) from the Facial Action Coding
            System for human expressions, 1978
          </ImageFig5Remark>
        </ColSecond>
      </Body>
    </Section>
